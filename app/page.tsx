...
<div className="flex flex-col items-center w-full mx-auto p-4 justify-center h-screen">
      ...
      <div className="card bg-white mt-5 px-5 md:w-[476px] w-full rounded-lg shadow-md pt-5 pb-10">
        <h1 className="text-heading-m pt-5">Login</h1>
        ...
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              className="rounded-lg block w-full pl-10 border border-dark-grey text-body-m  focus:border-metallic-gold focus:outline-metallic-gold focus:shadow-sm focus:shadow-metallic-gold"
          ...
          <label htmlFor="password" className="block text-body-s mt-5 mb-[-10px]">
            Password
          </label>
          ...
          <button
            type="submit"
            className="bg-hunyadi-yellow text-white text-heading-s w-full rounded-lg mt-5"
            disabled={loading}
          >
        ...
        <h1 className="flex mx-auto items-center justify-center mt-5 text-body-m">
          ...
          <a href="/signup" className="text-hunyadi-yellow pl-1">Create account</a>
        </h1>
      </div>
    </div>
  );
